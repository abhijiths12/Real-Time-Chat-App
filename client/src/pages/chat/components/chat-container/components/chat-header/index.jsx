...
const ChatHeader = () => {
    ...
    return (
        <div className="h-[10vh] border-b-2 border-[#2f303b] flex items-center justify-between px-20 w-full">
                ...
                <div className="flex gap-3 items-center justify-center ">
                    ...
                    <div className="w-12 h-12 relative">
                        ...
                        <Avatar className="h-12 w-12 rounded-full overflow-hidden">
                            {selectedChatData.image ? (<AvatarImage src={`${HOST}/${selectedChatData.image}`} className="object-cover w-full h-full bg-black" />) : (<div className={`uppercase h-12 w-12 text-lg border-[1px] flex items-center justify-center ${getColor(selectedChatData.color)}`}>
